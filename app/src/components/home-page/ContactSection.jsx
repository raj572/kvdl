  ...
  return (
    <div className="contact-container relative h-screen w-full overflow-hidden bg-black">
      ...
      >
        ...
        {/* Hotline */}
        <a href="tel:+918605558833" className="bg-gray-100 p-3 sm:p-4 rounded-xl flex items-start gap-3 hover:bg-gray-200 transition-colors">
          <FaPhoneAlt className="text-base sm:text-lg mt-1" />
          <div>
            <p className="text-sm font-semibold">Hotline:</p>
            <p className="text-xs sm:text-sm opacity-80">+91 86055 58833</p>
          </div>
        </a>

        {/* SMS / WhatsApp */}
        <a href="https://api.whatsapp.com/send/?phone=918605558833&text=Hello%2C+I+am+interested+in+Kedar+Vanjape+Developers+Projects.&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="bg-gray-100 p-3 sm:p-4 rounded-xl flex items-start gap-3 hover:bg-gray-200 transition-colors">
          <FaPhoneAlt className="text-base sm:text-lg mt-1" />
          <div>
        ...
        {/* Email */}
        <a href="mailto:sales@kvdl.in" className="bg-gray-100 p-3 sm:p-4 rounded-xl flex items-start gap-3 hover:bg-gray-200 transition-colors">
          <FaEnvelope className="text-base sm:text-lg mt-1" />
          <div>
            <p className="text-sm font-semibold">Email:</p>
            <p className="text-xs sm:text-sm opacity-80">sales@kvdl.in</p>
          </div>
        </a>
